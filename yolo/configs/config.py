...
parser.add_argument('--train_annotations_dir', type=str, default='configs/txt_files/voc_train.txt', help='train annotations path')
parser.add_argument('--test_annotations_dir', type=str, default='configs/txt_files/voc_test.txt', help='test annotations path')
parser.add_argument('--class_name_dir', type=str, default='configs/txt_files/voc2012.names', help='classes name path')
parser.add_argument('--yaml_dir', type=str, default='configs/yolo-s-mish.yaml', help='model.yaml path')
